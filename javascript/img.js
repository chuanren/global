...
/*
HOW TO DECLARE A NEW SLIDESHOW IN THE HTML:
...
//fadeimages[0]=["/news/path/title03.jpg", "", ""] //plain image syntax
//fadeimages[1]=["/news/path/title04.jpg", "", ""] //plain image syntax
...
function fadeshow(theimages, fadewidth, fadeheight, borderwidth, delay, pause, className, displayorder){
...
document.write('<div><img class="'+this.className+'" name="defaultslide'+this.slideshowid+'" src="'+this.postimages[0].src+'"></div>')
...
slideHTML+='<img class="'+this.className+'" src="'+this.postimages[picindex].src+'" border="'+this.imageborder+'px">'
if (this.theimages[picindex][1]!="") //if associated link exists for image
slideHTML+='</a>'
