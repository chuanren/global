...
function addBright(ctx,x,y,width,height,radius,opacity) {return;//chuanren
...
function addDark(ctx,x,y,width,height,radius,opacity) {//return;//chuanren
	var style = ctx.createLinearGradient(0,y,0,y+height);
...
function glossyShadow(ctx,x,y,width,height,radius,opacity){return;//chuanren
